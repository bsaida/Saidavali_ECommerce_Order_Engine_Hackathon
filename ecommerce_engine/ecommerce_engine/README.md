...
A menu-driven CLI application simulating a real-world e-commerce backend — built for the Hackathon Technical Assessment.

---

## Project Overview

Platforms like Amazon and Flipkart deal with millions of concurrent orders, inventory conflicts, payment failures, and fraud every day. This project simulates those backend complexities in a clean, modular Python application — covering everything from cart management and atomic order placement to fraud detection and event-driven architecture.
